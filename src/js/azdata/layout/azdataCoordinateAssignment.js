...
/**
 * Class: azdataCoordinateAssignment
 */

function azdataCoordinateAssignment(layout, intraCellSpacing, interRankCellSpacing,
 ...
 */
azdataCoordinateAssignment.prototype = new mxHierarchicalLayoutStage();
azdataCoordinateAssignment.prototype.constructor = azdataCoordinateAssignment;
 ...
 */
azdataCoordinateAssignment.prototype.layout = null;
 ...
 */
azdataCoordinateAssignment.prototype.intraCellSpacing = 30;
 ...
 */
azdataCoordinateAssignment.prototype.interRankCellSpacing = 100;
 ...
 * Default is 10.
 */
azdataCoordinateAssignment.prototype.parallelEdgeSpacing = 10;
 ...
 */
azdataCoordinateAssignment.prototype.maxIterations = 8;
 ...
 */
azdataCoordinateAssignment.prototype.prefHozEdgeSep = 5;
 ...
 */
azdataCoordinateAssignment.prototype.prefVertEdgeOff = 2;
 ...
 */
azdataCoordinateAssignment.prototype.minEdgeJetty = 12;
 ...
 */
azdataCoordinateAssignment.prototype.channelBuffer = 4;
 ...
 * absolute point
 */
azdataCoordinateAssignment.prototype.jettyPositions = null;
 ...
 */
azdataCoordinateAssignment.prototype.orientation = mxConstants.DIRECTION_NORTH;
 ...
 */
azdataCoordinateAssignment.prototype.initialX = null;
 ...
 */
azdataCoordinateAssignment.prototype.limitX = null;
 ...
 */
azdataCoordinateAssignment.prototype.currentXDelta = null;
 ...
 */
azdataCoordinateAssignment.prototype.widestRank = null;
 ...
 */
azdataCoordinateAssignment.prototype.rankTopY = null;
 ...
 */
azdataCoordinateAssignment.prototype.rankBottomY = null;
 ...
 */
azdataCoordinateAssignment.prototype.widestRankValue = null;
 ...
 */
azdataCoordinateAssignment.prototype.rankWidths = null;
 ...
 */
azdataCoordinateAssignment.prototype.rankY = null;
 ...
 */
azdataCoordinateAssignment.prototype.fineTuning = true;
 ...
 */
azdataCoordinateAssignment.prototype.nextLayerConnectedCache = null;
 ...
 */
azdataCoordinateAssignment.prototype.previousLayerConnectedCache = null;
 ...
 */
azdataCoordinateAssignment.prototype.groupPadding = 10;

/**
 * Utility method to display current positions
 */
azdataCoordinateAssignment.prototype.printStatus = function () {
...
azdataCoordinateAssignment.prototype.execute = function (parent) {
 ...
 */
azdataCoordinateAssignment.prototype.minNode = function (model) {
	// Queue all nodes
	var nodeList = [];
 ...
 */
azdataCoordinateAssignment.prototype.medianPos = function (i, model) {
 ...
 * relative to
 */
azdataCoordinateAssignment.prototype.rankMedianPosition = function (rankValue, model, nextRankValue) {
 ...
 */
azdataCoordinateAssignment.prototype.calculatedWeightedValue = function (currentCell, collection) {
	var totalWeight = 0;
 ...
 * rankValue - the layer number of this rank
 */
azdataCoordinateAssignment.prototype.medianXValue = function (connectedCells, rankValue) {
 ...
 * model - an internal model of the hierarchical layout
 */
azdataCoordinateAssignment.prototype.initialCoords = function (facade, model) {
	this.calculateWidestRank(facade, model);

	for (var i = model.ranks.length - 1; i >= 0; --i) {
 ...
 */
 ...
 azdataCoordinateAssignment.prototype.rankXOffset = 0;

azdataCoordinateAssignment.prototype.rankCoordinates = function (rankValue, graph, model) {
	var rank = model.ranks[rankValue];
	var maxY = 0.0;
	...
	var localX = 0;
	if (rankValue < model.ranks.length - 1 && rank.length > 0) {
		var firstNode = rank[0];
		var parentRank = model.ranks[rankValue+1];
		var foundParent = false;
		if (parentRank.length > 0) {
			for (var i = 0; i < parentRank.length && !foundParent; ++i) {
				var edgeCount = parentRank[i].cell.getEdgeCount();
				for (var j = 0; j < edgeCount; ++j) {
					if (parentRank[i].cell.getEdgeAt(j).target === firstNode.cell) {
						var bounds = this.layout.getVertexBounds(parentRank[i].cell);
						localX = parentRank[i].getX() - (bounds.width / 2);
						foundParent = true;
						break;
					}
				}
 ...
 * model - an internal model of the hierarchical layout
 */
azdataCoordinateAssignment.prototype.calculateWidestRank = function (graph, model) {
 ...
 * model - an internal model of the hierarchical layout
 */
azdataCoordinateAssignment.prototype.minPath = function (graph, model) {
 ...
 */
azdataCoordinateAssignment.prototype.repositionValid = function (model, cell, rank, position) {
 ...
 * model - the layout model
 */
azdataCoordinateAssignment.prototype.setCellLocations = function (graph, model) {
	this.rankTopY = [];
	this.rankBottomY = [];
 ...
 * model - the layout model
 */
azdataCoordinateAssignment.prototype.localEdgeProcessing = function (model) {
 ...
 */
azdataCoordinateAssignment.prototype.setEdgePosition = function (cell) {
 ...
 */
azdataCoordinateAssignment.prototype.setVertexLocation = function (cell) {
 ...
 */
azdataCoordinateAssignment.prototype.processReversedEdge = function (graph, model) {
